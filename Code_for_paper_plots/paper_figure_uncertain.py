...
def plot_curves():
    ...
    data2 = sio.loadmat('New_data/Portion1_2250/data2.mat')
    stress_test_2 = data2['stress_test']
    stress_weight_test_2 = data2['stress_weight_test']

    data3 = sio.loadmat('New_data/Portion1_2250/data3.mat')
    stress_test_3 = data3['stress_test']
    stress_weight_test_3 = data3['stress_weight_test']

    data4 = sio.loadmat('New_data/Portion1_2250/data4.mat')
    stress_test_4 = data4['stress_test']
    stress_weight_test_4 = data4['stress_weight_test']

    data5 = sio.loadmat('New_data/Portion1_2250/data5.mat')
    stress_test_5 = data5['stress_test']
    stress_weight_test_5 = data5['stress_weight_test']

    data6 = sio.loadmat('New_data/Portion1_2250/data6.mat')
    stress_test_6 = data6['stress_test']
    ...
    #plot_idx_list = [7, 196, 170, 37, 20, 33]
    ...
    for iplot, idx_plot in enumerate(plot_idx_list):
        def single_subplot(y, y_pred, y_test_std, y_std, irow, icol, title):
            color_map = {0:'b',1:'r',2:'g',3:'c',4:'m',5:'k'}
            strain_plot = strain
            axs[irow,icol].plot(strain_plot, y_pred[0], '--'+color_map[irow])
            axs[irow,icol].plot(strain_plot, y_pred[1], '--'+color_map[irow])
            ...
            axs[irow,icol].plot(strain_plot, y[0], '-'+color_map[irow+3])
            axs[irow,icol].plot(strain_plot, y[1], '-'+color_map[irow+3])
    ...
    plt.savefig('./Curve_uncertainty_2250_fin.png')
    plt.close()
